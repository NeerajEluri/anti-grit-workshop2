...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: "bg-agri-600 hover:bg-agri-700 text-white shadow-md shadow-agri-600/20 focus:ring-agri-500",
    secondary: "bg-slate-900 hover:bg-slate-800 text-white shadow-md focus:ring-slate-700",
    outline: "border border-slate-300 bg-white hover:bg-slate-50 text-slate-700 focus:ring-agri-500",
